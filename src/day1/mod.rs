...
fn get_first_number_char(line: impl Iterator<Item = char>) ->
...
fn get_first_number_word(line: &str) -> Result<u32, &'static str> {
...
// first number word or number character, depending on which comes first
fn get_last_number_word(line: &str) -> Result<u32, &'static str> {

...
fn main() {
    ...
    let result: String = match aoc_day {
        ...
        9 => match aoc_puzzle_of_day {
            1 => day9::puzzle1(file_content),
            2 => day9::puzzle2(file_content),
            _ => invalid_puzzle_num_str,
        },

        10 => match aoc_puzzle_of_day {
            1 => day10::puzzle1(file_content),
            _ => invalid_puzzle_num_str,
        },
